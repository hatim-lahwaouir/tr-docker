...
const GameLocal: React.FC = () => {
  const {gameSetting, Player1, Player2} = useGameContext()
...
const playersAnimation=()=>{
  ...
  useEffect(()=>{
    if (player1score >= 5 || player2score >= 5){
      if (player1score >= 5)
          setthewinner(Player1)
      else
        setthewinner(Player2)
      setisfinish(true);
    }
  ...
  const Winpanel = () =>{
    ...
    return (
      <div className="fixed z-50  inset-0 flex items-center justify-center ">
				<div className="backdrop-blur-[2px]  bg-[#0000000e] dark:bg-[#ffffff2b]  min-w-full min-h-full absolute"></div>

					<div className="flex flex-col dark:bg-black bg-white rounded-xl w-72 items-center p-6 relative m-3" >
						<div className="text-4xl text-bold text-center mt-3">{thewinner}</div>
						<div className="text-5xl text-bold text-center mt-3 font-serif">WIN</div>
						<div className="text-2xl text-bold text-center mt-3">
            <button className="bg-black dark:bg-white flex-1 h-10 rounded-xl dark:text-black text-white flex items-center justify-center hover:bg-[#212121] active:bg-[#797979] dark:hover:bg-[#cecdcd] dark:active:bg-[#9d9d9d] w-44" type="button" onClick={()=>{
              setPlayer1score(0);
              setPlayer2score(0);
              setisfinish(false);
            }
						...
						<div className="text-2xl text-bold text-center mt-3">
            <button className="bg-black dark:bg-white flex-1 h-10 rounded-xl dark:text-black text-white flex items-center justify-center hover:bg-[#212121] active:bg-[#797979] dark:hover:bg-[#cecdcd] dark:active:bg-[#9d9d9d] w-44" type="button"
            onClick={()=>{
              navigate('/game')
              setisfinish(false);
            }}>Back Home</button>
